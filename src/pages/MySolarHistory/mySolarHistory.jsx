...
export default function MySolarHistory() {
  ...
  const renderWeatherIcon = (weather) => {
    switch (weather) {
      case 'Sunny': return <span className="flex items-center gap-1 text-amber-500 font-bold"><Sun size={14} className="animate-spin-slow" /> Sunny</span>;
      case 'Partly Cloudy': return <span className="flex items-center gap-1 text-amber-400 font-medium"><CloudSun size={14} /> Cloudy-Sun</span>;
      case 'Cloudy': return <span className="flex items-center gap-1 text-gray-500 font-medium"><Cloud size={14} /> Cloudy</span>;
      case 'Rainy': return <span className="flex items-center gap-1 text-blue-500 font-bold"><CloudRain size={14} /> Rainy</span>;
  ...
  const renderStatusBadge = (status) => {
    switch (status) {
      case 'Optimal':
        return (
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-[10px] uppercase font-black tracking-wider bg-emerald-50 text-emerald-700 border border-emerald-200/50 shadow-sm relative overflow-hidden">
      ...
      case 'Active':
        return (
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-[10px] uppercase font-black tracking-wider bg-indigo-50 text-indigo-700 border border-indigo-200/50 shadow-sm relative overflow-hidden">
            <span className="relative flex h-1.5 w-1.5">
      ...
      case 'Low Yield':
        return (
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-[10px] uppercase font-black tracking-wider bg-amber-50 text-amber-700 border border-amber-200/50 shadow-sm relative overflow-hidden">
            <span className="relative flex h-1.5 w-1.5">
    ...
    <div className="p-3 sm:p-4 md:p-5 space-y-2 md:space-y-3 flex flex-col h-full min-h-0 overflow-y-auto scrollbar-thin scroll-smooth font-sans pb-8">
          ...
          {['Day', 'Week', 'Month', 'Year', 'Lifetime'].map((view) => (
            <button
              ...
              className={`px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg sm:rounded-xl text-[9px] sm:text-[11px] font-extrabold transition-all duration-200 ${activeView === view
                  ? 'bg-indigo-600 text-white shadow-md shadow-indigo-100/30 scale-[1.02] border border-indigo-600'
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <div className="relative h-[28px] sm:h-[32px]">
                <div className="bg-white border border-slate-200 hover:border-indigo-400 rounded-lg sm:rounded-xl px-2 sm:px-2.5 h-[28px] sm:h-[32px] flex items-center text-[10px] sm:text-xs font-bold text-slate-700 shadow-sm pointer-events-none min-w-[85px] sm:min-w-[105px] transition-all duration-200">
                  <Calendar size={10} className="text-indigo-400 mr-1 sm:mr-1.5 flex-shrink-0 sm:w-3 sm:h-3" />
                  {toDDMMYYYY(fromDate)}
                </div>
                <input
                  type="date"
      ...
      <div className="space-y-1.5">
        ...
        <div className="grid grid-cols-6 sm:grid-cols-3 xl:grid-cols-6 gap-1 sm:gap-2">
          ...
          <div className="w-full bg-white/80 backdrop-blur-md rounded-lg sm:rounded-xl p-1 sm:p-3 border border-indigo-100/60 shadow-sm hover:shadow-xl hover:border-indigo-300/80 transition-all duration-300 hover:-translate-y-0.5 flex flex-col items-center sm:items-start justify-center sm:justify-between group relative overflow-hidden text-center sm:text-left">
            <div className="absolute right-[-12px] top-[-12px] w-14 h-14 bg-indigo-100/40 rounded-full flex items-center justify-center group-hover:scale-125 transition-transform duration-300"></div>
            <div className="flex flex-col sm:flex-row items-center gap-0.5 sm:gap-1.5 text-slate-400 font-black uppercase text-[4px] sm:text-[9px] tracking-wider z-10 w-full justify-center sm:justify-start">
              <Zap size={8} className="text-indigo-500 fill-indigo-50 sm:w-3 sm:h-3 hidden sm:block" />
              <span className="w-full leading-none sm:leading-tight">Total Units</span>
            </div>
            <div className="mt-0.5 sm:mt-1.5 z-10 w-full">
              <span className="text-[7px] sm:text-lg md:text-xl font-black text-indigo-950 block tracking-tighter">
          ...
          <div className="w-full bg-white/80 backdrop-blur-md rounded-lg sm:rounded-xl p-1 sm:p-3 border border-indigo-100/60 shadow-sm hover:shadow-xl hover:border-indigo-300/80 transition-all duration-300 hover:-translate-y-0.5 flex flex-col items-center sm:items-start justify-center sm:justify-between group relative overflow-hidden text-center sm:text-left">
            <div className="absolute right-[-12px] top-[-12px] w-14 h-14 bg-amber-100/40 rounded-full flex items-center justify-center group-hover:scale-125 transition-transform duration-300"></div>
            <div className="flex flex-col sm:flex-row items-center gap-0.5 sm:gap-1.5 text-slate-400 font-black uppercase text-[4px] sm:text-[9px] tracking-wider z-10 w-full justify-center sm:justify-start">
              <Clock size={8} className="text-amber-500 sm:w-3 sm:h-3 hidden sm:block" />
          ...
          <div className="w-full bg-white/80 backdrop-blur-md rounded-lg sm:rounded-xl p-1 sm:p-3 border border-indigo-100/60 shadow-sm hover:shadow-xl hover:border-indigo-300/80 transition-all duration-300 hover:-translate-y-0.5 flex flex-col items-center sm:items-start justify-center sm:justify-between group relative overflow-hidden text-center sm:text-left">
            <div className="absolute right-[-12px] top-[-12px] w-14 h-14 bg-emerald-100/40 rounded-full flex items-center justify-center group-hover:scale-125 transition-transform duration-300"></div>
            <div className="flex flex-col sm:flex-row items-center gap-0.5 sm:gap-1.5 text-slate-400 font-black uppercase text-[4px] sm:text-[9px] tracking-wider z-10 w-full justify-center sm:justify-start">
              <TrendingUp size={8} className="text-emerald-500 sm:w-3 sm:h-3 hidden sm:block" />
          ...
          <div className="w-full bg-white/80 backdrop-blur-md rounded-lg sm:rounded-xl p-1 sm:p-3 border border-rose-100/60 shadow-sm hover:shadow-xl hover:border-rose-300/80 transition-all duration-300 hover:-translate-y-0.5 flex flex-col items-center sm:items-start justify-center sm:justify-between group relative overflow-hidden text-center sm:text-left">
            <div className="absolute right-[-12px] top-[-12px] w-14 h-14 bg-rose-100/40 rounded-full flex items-center justify-center group-hover:scale-125 transition-transform duration-300"></div>
            <div className="flex flex-col sm:flex-row items-center gap-0.5 sm:gap-1.5 text-slate-400 font-black uppercase text-[4px] sm:text-[9px] tracking-wider z-10 w-full justify-center sm:justify-start">
              <ArrowUpRight size={8} className="text-rose-600 bg-rose-50 rounded sm:w-3 sm:h-3 hidden sm:block" />
              <span className="w-full leading-none sm:leading-tight">Max Gen</span>
            </div>
            <div className="mt-0.5 sm:mt-1.5 z-10 w-full">
              <span className="text-[7px] sm:text-lg md:text-xl font-black text-rose-600 block tracking-tighter">
          ...
          <div className="w-full bg-white/80 backdrop-blur-md rounded-lg sm:rounded-xl p-1 sm:p-3 border border-teal-100/60 shadow-sm hover:shadow-xl hover:border-teal-300/80 transition-all duration-300 hover:-translate-y-0.5 flex flex-col items-center sm:items-start justify-center sm:justify-between group relative overflow-hidden text-center sm:text-left">
            <div className="absolute right-[-12px] top-[-12px] w-14 h-14 bg-teal-100/40 rounded-full flex items-center justify-center group-hover:scale-125 transition-transform duration-300"></div>
            <div className="flex flex-col sm:flex-row items-center gap-0.5 sm:gap-1.5 text-slate-400 font-black uppercase text-[4px] sm:text-[9px] tracking-wider z-10 w-full justify-center sm:justify-start">
              <ArrowDownRight size={8} className="text-teal-600 bg-teal-50 rounded sm:w-3 sm:h-3 hidden sm:block" />
              <span className="w-full leading-none sm:leading-tight">Min Gen</span>
            </div>
            <div className="mt-0.5 sm:mt-1.5 z-10 w-full">
              <span className="text-[7px] sm:text-lg md:text-xl font-black text-teal-600 block tracking-tighter">
          ...
          <div className="w-full bg-white/80 backdrop-blur-md rounded-lg sm:rounded-xl p-1 sm:p-3 border border-indigo-100/60 shadow-sm hover:shadow-xl hover:border-indigo-300/80 transition-all duration-300 hover:-translate-y-0.5 flex flex-col items-center sm:items-start justify-center sm:justify-between group relative overflow-hidden text-center sm:text-left">
            <div className="absolute right-[-12px] top-[-12px] w-14 h-14 bg-purple-100/40 rounded-full flex items-center justify-center group-hover:scale-125 transition-transform duration-300"></div>
            <div className="flex flex-col sm:flex-row items-center gap-0.5 sm:gap-1.5 text-slate-400 font-black uppercase text-[4px] sm:text-[9px] tracking-wider z-10 w-full justify-center sm:justify-start">
              <Percent size={8} className="text-purple-500 sm:w-3 sm:h-3 hidden sm:block" />
      ...
      {/* 4. Chart Section */}
      {activeSection === 'chart' && (
        <div className="bg-white/80 backdrop-blur-md rounded-2xl p-2 sm:p-3 border border-indigo-100/60 shadow-md hover:shadow-lg transition-all duration-300 flex-1 min-h-0 min-h-[300px] flex flex-col animate-fade-in">
      ...
      {activeSection === 'table' && (
        <div className="bg-white/80 backdrop-blur-md rounded-3xl border border-indigo-100/60 shadow-md overflow-hidden flex flex-col hover:shadow-lg transition-all duration-300 animate-fade-in flex-1 min-h-0 min-h-[400px]">
          ...
          <div className="px-3 sm:px-4 py-2 border-b border-slate-100/80 flex items-center justify-between gap-2 sm:gap-3 bg-white/40">
            ...
            <div className="flex-shrink-0 flex items-center gap-1 sm:gap-1.5 whitespace-nowrap">
              <h3 className="text-[10px] sm:text-xs font-extrabold text-indigo-950 uppercase tracking-widest">
            ...
            <div className="hidden sm:block flex-1 min-w-0 relative max-w-sm">
              ...
              <input
                ...
                className="w-full bg-white border border-slate-200 rounded-xl pl-8 pr-7 text-xs font-semibold text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/15 focus:border-indigo-500 h-[30px] shadow-sm transition-all duration-200"
              />
              {tableSearch && (
                <button
            ...
            <div className="hidden sm:flex flex-shrink-0 items-center gap-2">
              ...
              <div className="text-xs bg-indigo-50/50 px-2.5 py-0.5 rounded-xl border border-indigo-100/30 text-indigo-700 font-black shadow-sm whitespace-nowrap">
          ...
          <DataTable
            headers={[
              ...
              <span className="flex items-center justify-center gap-1.5 text-[11px] font-black text-indigo-950 uppercase tracking-widest"><Calendar size={13} className="text-slate-400" /> Time</span>,
              <span className="flex items-center justify-center gap-1.5 text-[11px] font-black text-indigo-950 uppercase tracking-widest"><Zap size={13} className="text-indigo-500 fill-indigo-100" /> Generation kWh</span>,
              <span className="flex items-center justify-center gap-1.5 text-[11px] font-black text-indigo-950 uppercase tracking-widest"><TrendingUp size={13} className="text-slate-400" /> Power kW</span>,
              <span className="flex items-center justify-center gap-1.5 text-[11px] font-black text-indigo-950 uppercase tracking-widest"><Sun size={13} className="text-amber-500 animate-spin-slow" /> Weather</span>,
              <span className="flex items-center justify-center gap-1.5 text-[11px] font-black text-indigo-950 uppercase tracking-widest"><Info size={13} className="text-indigo-500" /> Status</span>
            ]}
            ...
            renderRow={(item, idx) => {
              ...
              return (
                <tr key={idx} className="hover:bg-indigo-50/20 transition-colors duration-200 border-b border-slate-100">
                  ...
                  <td className="px-6 py-3.5 text-center whitespace-nowrap text-indigo-600 font-black text-sm">
            ...
            renderCard={(item, idx) => {
              const globalIdx = idx + 1;
              return (
                <div key={idx} className="bg-white/90 backdrop-blur-sm p-2 sm:p-4 rounded-xl sm:rounded-2xl border border-indigo-100/60 shadow-sm hover:shadow-md transition-all duration-200 space-y-1.5 sm:space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-1.5 sm:gap-3 text-xs bg-slate-50/50 p-1.5 sm:p-2.5 rounded-lg sm:rounded-xl border border-slate-100">
                    <div>
                      ...
                      <span className="font-black text-indigo-600 text-[10px] sm:text-sm">{item.generation.toFixed(2)} kWh</span>
                    </div>
                    <div>
