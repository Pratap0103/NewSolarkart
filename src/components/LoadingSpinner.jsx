  ...
  return (
    <div className={containerClasses}>
      <div className="relative">
        ...
        <div className="w-12 h-12 border-4 border-brand-navy border-dashed rounded-full animate-spin"></div>
        
        {/* Inner solid pulse (optional flair) */}
        <div className="absolute inset-2 bg-brand-navy/10 rounded-full animate-pulse opacity-40"></div>
      </div>
      ...
      <div className="mt-6 flex flex-col items-center space-y-2">
        ...
        <div className="flex gap-1">
          <div className="w-1.5 h-1.5 bg-brand-navy rounded-full animate-bounce [animation-delay:-0.3s]"></div>
          <div className="w-1.5 h-1.5 bg-brand-navy rounded-full animate-bounce [animation-delay:-0.15s]"></div>
